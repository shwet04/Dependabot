...
host = "127.0.0.1"
#host = "connection to the aws database"
#gh_token = "Github personal access token"

connection = psycopg2.connect(user="shweta.singh",
                                      password="root",
                                      host="127.0.0.1",
                                      port="5432",
                                      database="dependabot")                                 
...
def get_repos(host, gh_token):
    # host="https://github.com/organizations/AppDirect/api/v3"
    ...
    org = g.get_organization("AppDirect")

    # get all repositories
    repos = org.get_repos()

    len = 0
    # iterate through the repositories and print their names
    for repo in repos:
        if len == 10:
            break
    ...
    # g.get_organizations("AppDirect")
    # for org in g.get_organizations("AppDirect"):
